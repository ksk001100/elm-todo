...
var $author$project$Main$deleteTodo = F2(
	function (id, todos) {
		...
		if (_v0.$ === 'Just') {
			var index = _v0.a;
			return A2($elm_community$list_extra$List$Extra$removeAt, index, todos);
		} else {
			return todos;
		}
	});
...
var $author$project$Main$getNextId = function (todos) {
	var _v0 = $elm$core$List$head(todos);
	if (_v0.$ === 'Just') {
		var todo = _v0.a;
		return todo.id + 1;
	} else {
		...
		switch (msg.$) {
			...
			case 'Delete':
				...
				return _Utils_update(
					model,
					{
						todos: A2($author$project$Main$deleteTodo, id, model.todos)
					});
			default:
				return _Utils_update(
					model,
					{
						...
						todos: A2(
							...
							{
								body: model.input,
								id: $author$project$Main$getNextId(model.todos)
							},
							model.todos)
					});
		}
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('todo-table-col')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('todo-table')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('todo-table-head')
							]),
						_List_fromArray(
							[
								A2(
